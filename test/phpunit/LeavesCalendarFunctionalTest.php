...
/**
 * \file    test/functional/LeavesCalendarFunctionalTest.php
...
/**
 * Class LeavesCalendarFunctionalTest
 *
 ...
 *
 * @package Testleavescalendar
 */
class LeavesCalendarFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modLeavesCalendar')->click();
		} else {
			// Disable the module
			$this->byHref('modLeavesCalendar')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/leavescalendar/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('leavescalendar/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/leavescalendar/admin/about.php');
		$this->authenticate();
		return $this->assertContains('leavescalendar/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('leavescalendarwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modLeavesCalendar_LeavesCalendarTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLeavesCalendar_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
